...
class WatchSnapshotSynchronizerTest {
    ...
    fun `clears old etag before cache writes and stores replacement etag last`() = runBlocking {
        ...
        assertTrue(synchronizer.refresh() is SnapshotSyncResult.Success)
        assertEquals(listOf("metadata.clear", "snapshot.cache", "quick_add.cache", "metadata.store"), events)
    ...
    private fun validSnapshot(): String = """
        {
          "server_time":"2026-07-11T01:00:00Z","timezone":"America/Los_Angeles",
          ...
          "weight":{"today_grams":null,"today_revision":null,"latest_grams":81500,"latest_date":"2026-07-11"},
