...
CREATE TABLE "BodyMetricTrend" (
  ...
  "date" DATE NOT NULL,
  "trend_weight_kg" DOUBLE PRECISION NOT NULL,
  "trend_ci_lower_kg" DOUBLE PRECISION NOT NULL,
  "trend_ci_upper_kg" DOUBLE PRECISION NOT NULL,
  "trend_std_kg" DOUBLE PRECISION NOT NULL,
