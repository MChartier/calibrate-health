...
export const pgPool = new Pool({ ...parseDatabaseUrlToPgConfig(databaseUrl), ssl: resolvePgSslConfig(databaseUrl) });
const adapter = new PrismaPg(pgPool, { schema: resolvePrismaSchema(databaseUrl) });
