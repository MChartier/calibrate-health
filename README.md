...
- `npm run native:configure -- --credentials-file <signing-json> --service-account-file <play-json>`:
  save external credential-file paths for this machine so build and submit need no repeated arguments.
